...
function Comments(props) {
        ...
        axios.post('/api/comment/saveComment', variables)
            .then(response => {
                if (response.data.success) {
                    ...
                    props.refreshFunction(response.data.result) // refreshFunction은 DetailProductPage.js에서 updateComment함수임
                } else {
    ...
    return (
        <div>
            ...
            <p> 댓글 </p>
            <hr />
            {/* Comment Lists : 사용자들이 입력했던 댓글들이 리스트형태로 쭉 나열되어 실제로 보여지는 부분 */}
