...
import {
  ...
  Routes, // Switch는 v5버전이고, 현재는 v6이므로 Routes를 씀
  Route,
  Link
...
export default App; // es6에서는 내보낼 단일객체를 위해 export를 사용하고, 그 이전 버전의 CommonJS에서는 module.exports를 사용한다.
...
// =======[코드 설명]==========
  ...
  // Auth 함수는 client/src/hoc/auth.js와 관련 있는 함수다.
  ...
  // admin인 유저(관리자)만 들어갈 수 있는 페이지를 만들기 위해서는 다음과 같이 코딩한다.
